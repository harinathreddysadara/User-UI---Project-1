<template>
  ...
  >
    ...
    <v-card-subtitle style=";font-family:Comic Sans, Comic Sans MS, cursive;" class="pb-0">{{product.product}}</v-card-subtitle>
    ...
    <v-card-text style=";font-family:Comic Sans, Comic Sans MS, cursive;" class="text--primary">
